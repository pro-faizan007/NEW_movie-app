...
export default function MovieList() {
    ...
    const { movieFilterOnSearch, searchData, pages, selectedPage, selectedPageNumber, paginatedMovies, movieDetailShow } = context

    return (
        <>
            <div className="movie-list">
                {searchData.length > 1 ? movieFilterOnSearch.map((value) => {
